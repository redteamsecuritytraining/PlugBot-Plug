...
<head>
	...
	<title>Config - View All Jobs</title>
...
<div id="log_form">
    ...
    <div class="info">View All Jobs (<?php echo $this->db->count_all('tblJob'); ?> entries)</div>
    <?php echo $this->session->flashdata('messages'); ?>

         <div id="container">
                <?php $this->table->set_heading(array('ID', 'Botkey', 'Name','Command')); ?>
